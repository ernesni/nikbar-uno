...
@JavaScript("./src/my-scripts/swipe-away.js")
public class NaviDrawer extends Div implements AfterNavigationObserver {

	private static final long serialVersionUID = -3177509070979746494L;
	...
	private void initHeader() {
		mainContent.add(new BrandExpression(Constante.NAME_PROYECT_SHORT));
	}
