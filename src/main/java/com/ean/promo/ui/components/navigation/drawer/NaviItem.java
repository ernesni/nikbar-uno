...
public class NaviItem extends ListItem {
	...
	private static final long serialVersionUID = -8798304816347699134L;
	...
	public NaviItem(String text, Class<? extends Component> navigationTarget) {
		...
		if (navigationTarget != null) {
			RouterLink routerLink = new RouterLink("", navigationTarget); //new RouterLink(null, navigationTarget);
